...
export const MainPage = (): JSX.Element => {
  ...
  return (
    <main className="flex flex-col items-center w-full overflow-hidden">
      <Navbar />
      <div className="w-full py-20 relative bg-gradient-to-br from-indigo-900 via-purple-900 to-blue-500 overflow-hidden">
        ...
        <div className="relative pointer-events-none">
          <ParallaxContainer speed={0.3} className="absolute bottom-[9px] left-[311px]">
            <motion.div 
              className="w-[81px] h-[81px] bg-[url(/vector.svg)] bg-[100%_100%]"
