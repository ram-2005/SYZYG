import { Contact } from "../screens/MainPage/sections/ContactFormSection/Contact";
...
export function Contactpage() {
  return (
    <div className="min-h-screen w-full py-20 relative bg-gradient-to-br from-indigo-900 via-purple-900 to-blue-500 overflow-hidden">
        <Navbar />
